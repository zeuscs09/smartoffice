    ...
    <div class="drawer">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <div class="navbar bg-base-100">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center">
                            ...
                            <div class="hidden lg:flex space-x-2">
                                ...
                                <button 
                                    v-if="menuPermissions.employeeList"
                                    class="btn btn-ghost btn-circle tooltip tooltip-bottom" 
                                    data-tip="Employees"
                ...
                <div class="flex-none">
                    ...
                    <button class="btn btn-ghost btn-circle tooltip tooltip-bottom" data-tip="Task"
                    ...
                    <button class="btn btn-ghost btn-circle tooltip tooltip-bottom" data-tip="Work Load"
                    ...
                    <button class="btn btn-ghost btn-circle tooltip tooltip-bottom" data-tip="Mail Box"
                        @click="router.push({ name: 'MailBoxList' })">
                        <div class="indicator">
                            <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    ...
                    <div class="dropdown dropdown-end">
                        ...
                        <ul tabindex="0"
                            ...
                            <li><a :href="`/app/user/${session.user}?from_page=/intranet`" target="_blank">Profile</a>
                            </li>
            ...
            <!-- Page content here -->
            <div class="p-4  bg-base-100 flex-grow shadow-lg rounded-sm mt-2 sm:m-4">
                <slot></slot>
            </div>
        </div>
        ...
        <div class="drawer-side z-[999] lg:hidden">
            ...
            <ul class="menu p-4 w-80 min-h-full bg-base-200 text-base-content">
                ...
                <li v-if="menuPermissions.employeeList">
                    <a @click="router.push('/employees/list')" class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        Employees
                    </a>
